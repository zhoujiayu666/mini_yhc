...
export type Item = {id:string; title:string; subtitle:string; image:string; filename:string; target:number; sku?:string; category?:string; detailImages?:string[]; detailBlocks?:DetailBlock[]; price?:number; originalPrice?:number};
...
export type Config = {version:1; blocks:Block[]};
