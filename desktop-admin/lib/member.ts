...
export type MemberProduct={id:string;title:string;image:string;points:number;visible:boolean;description:string;exchangeInstructions:string;detailImages?:string[];detailBlocks?:MemberContent[]};
